...
char *at4 = "AT+CWSAP=\"ESP8266_vincent\",\"0123456789\",11,3\r\n";
char *at5 = "AT+CIPMUX=1\r\n";
char *at6 = "AT+CIPSERVER=1,8080\r\n";

char *at7 = "AT+CWMODE=1\r\n"; // 1:从端, 2:热点, 3:兼而有之
char *at8 = "AT+CWLAP\r\n";
char *at9 = "AT+CWJAP=\"ESP8266_vincent\",\"0123456789\"\r\n";
char *at10 = "AT+CIFSR\r\n";

char *at11 = "AT+CIPSTART=\"TCP\",\"192.168.4.1\",8080\r\n";
char *at13 = "AT+CIPSEND=10\r\n";

char *at12 = "AT+CIPSTART=0,\"TCP\",\"192.168.4.1\",8080\r\n";
char *at14 = "AT+CIPSEND=0,10\r\n";
